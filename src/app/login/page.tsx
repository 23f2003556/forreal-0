            ...
            >
                ...
                <div className="bg-zinc-900/50 backdrop-blur-xl border border-white/10 p-8 rounded-3xl shadow-2xl">
                    ...
                    <button
                        ...
                        disabled={loading}
                        className="mt-6 w-full flex items-center justify-center gap-3 bg-white/5 border border-white/10 hover:bg-white/10 text-white font-semibold py-3.5 px-4 rounded-2xl focus:outline-none transition-all disabled:opacity-50 hover:scale-[1.02] active:scale-[0.98]"
                    >
